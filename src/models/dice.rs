...
#[diesel(sql_type = crate::database::schema::sql_types::Dice)]
...
impl ToSql<crate::database::schema::sql_types::Dice, Pg> for Dice {
...
impl FromSql<crate::database::schema::sql_types::Dice, Pg> for Dice {
